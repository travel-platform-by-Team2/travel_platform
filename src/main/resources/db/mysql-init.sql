...
values
  ...
  ('kakao_40001', '경주 라한 셀렉트', '경주라한셀렉트', 'AD5', '숙박 > 호텔', '054-000-0001', '경상북도 경주시', '경상북도 경주시 보문로 338', 'gyeongbuk', 35.8382000, 129.2827000, 'https://place.map.kakao.com/40001', 240000, 43200, 1),
  ('kakao_50001', '강릉 씨사이드 호텔', '강릉씨사이드호텔', 'AD5', '숙박 > 호텔', '033-000-0001', '강원특별자치도 강릉시', '강원특별자치도 강릉시 창해로 307', 'gangwon', 37.7797000, 128.9435000, 'https://place.map.kakao.com/50001', 210000, 37800, 1);
